""" Module to Output a List of Winners depending on their Votes """
...
def who_is_winner(votes):
    ...
    for participant in participants:
        # List comprehension to count every occurrence of the Name
    ...
    # winning Amount is the Number the Participant with the most Votes reached
    ...
    if len(winners) == 1:
        ...
        # if you just want to return a List of Winners,
        # skip this part until you see a Line like below
        win_notification = "The Winners are "

        # this is the Amount of different Winners, if they got the same Amount of Votes
        winners_ = len(winners)

        # this a Loop where we get all Winners except the last one
        # to add them to the Notification separated with a Comma
